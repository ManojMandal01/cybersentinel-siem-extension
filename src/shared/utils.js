...
export function hasHomograph(domain) {
  ...
  // Only flag known confusable substitutions. Do not treat the legitimate
  // spelling of a brand (for example, paypal.com) as a homograph.
  const confusables = /paypa[1i]|g00gle|micr0soft|arnazon/i.test(domain);
